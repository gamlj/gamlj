...
Any plot produced by `gamljGlm` or `plot()` can be obtained as a ggplot2 object for futher manipolations or usage. For instance, one can change the theme of the plot:
