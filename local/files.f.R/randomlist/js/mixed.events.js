...
//        console.log("change in random supplier");
    ...
    onUpdate_randomSupplier: function(ui) {
       // slow // updateRandomSupplier(ui,this);
...
//      }
    ...
    onEvent_re_list: function(ui, data) {
...
// then we check how to prepare the list
    ...
    if ( option != "model" ) {
       ...
       var variableList = factorList.concat(covariatesList);
        ...
        if ( option === "all")  order = variableList.length
        
        termsList = interactions(covariatesList, order);
...
// for instance, order=1 remove any matching interaction with terms, keeps get effects
