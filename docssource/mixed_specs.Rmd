...
Post-hocs tests are performed as implemented in the [lsmeans package](https://cran.r-project.org/web/packages/lsmeans/index.html). In particular, the actual implementation is as follows (for any given model term selected by the user) :
