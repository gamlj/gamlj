...
This implementation is based on [emmeans package](https://cran.r-project.org/web/packages/emmeans/index.html), which explains that because dependent variable categories probabilities sum to 1 (and the latent values sum to 0) over the multivariate-response levels, all sensible results from lsmeans must involve that response as one of the factors.
