...
gamljlmOptions <- if (requireNamespace("jmvcore", quietly = TRUE)) {
    R6::R6Class(
        "gamljlmOptions",
        inherit = jmvcore::Options,
        public = list(
            initialize = function(.caller = "lm",
                                  .interface = "jamovi",
                                  model_type = "lm",
                                  dep = NULL,
                                  factors = NULL,
...
gamljlmResults <- if (requireNamespace("jmvcore", quietly = TRUE)) {
    R6::R6Class(
        "gamljlmResults",
...
gamljlmBase <- if (requireNamespace("jmvcore", quietly = TRUE)) {
    R6::R6Class(
        "gamljlmBase",
