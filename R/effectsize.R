...
.add_es.main_anova_clm <- function(atable, model, obj) return(.add_es.main_anova_glm(atable,model,obj))

.add_es.main_anova_multi <- function(atable, model, obj) return(.add_es.main_anova_glm(atable,model,obj))
