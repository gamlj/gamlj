...
WARNS["stde.robust_test"] <- "Inferential tests and p-values are based on robust estimation."
WARNS["norobustanova"] <- "robust estimation not available for the omnibus tests."
