...
gamljglmOptions <- if (requireNamespace("jmvcore", quietly = TRUE)) {
    R6::R6Class(
        "gamljglmOptions",
        inherit = jmvcore::Options,
        public = list(
            initialize = function(.caller = "glm",
                                  .interface = "jamovi",
                                  dep = NULL,
                                  dep2 = NULL,
                                  factors = NULL,
...
gamljglmResults <- if (requireNamespace("jmvcore", quietly = TRUE)) {
    R6::R6Class(
        "gamljglmResults",
...
gamljglmBase <- if (requireNamespace("jmvcore", quietly = TRUE)) {
    R6::R6Class(
        "gamljglmBase",
