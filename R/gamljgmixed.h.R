...
gamljgmixedOptions <- if (requireNamespace("jmvcore", quietly = TRUE)) {
    R6::R6Class(
        "gamljgmixedOptions",
        inherit = jmvcore::Options,
        public = list(
            initialize = function(.caller = "glmer",
                                  .interface = "jamovi",
                                  dep = NULL,
                                  factors = NULL,
                                  covs = NULL,
...
gamljgmixedResults <- if (requireNamespace("jmvcore", quietly = TRUE)) {
    R6::R6Class(
        "gamljgmixedResults",
...
gamljgmixedBase <- if (requireNamespace("jmvcore", quietly = TRUE)) {
    R6::R6Class(
        "gamljgmixedBase",
