...
gamljmixedOptions <- if (requireNamespace("jmvcore", quietly = TRUE)) {
    R6::R6Class(
        "gamljmixedOptions",
        inherit = jmvcore::Options,
        public = list(
            initialize = function(.caller = "lmer",
                                  .interface = "jamovi",
                                  model_type = "lmer",
                                  dep = NULL,
                                  factors = NULL,
...
gamljmixedResults <- if (requireNamespace("jmvcore", quietly = TRUE)) {
    R6::R6Class(
        "gamljmixedResults",
...
gamljmixedBase <- if (requireNamespace("jmvcore", quietly = TRUE)) {
    R6::R6Class(
        "gamljmixedBase",
